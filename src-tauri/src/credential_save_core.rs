...
pub async fn save_scheduler_credential_core(
    ...
    if provider == "upload_post" {
        ...
        let _ = crate::account_config::sync_accounts_for_provider(provider, api_key, path_bufs).await;
    }
    ...
    for repo_path in matching_paths {
        ...
        let _ = crate::platform_config_sync::sync_connected_platforms_to_config_impl(
