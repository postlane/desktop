...
pub(crate) fn all_commands() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        crate::workspace_migration_commands::migration_status,
        crate::workspace_migration_commands::dismiss_migration,
        crate::workspace_migration_commands::start_workspace_migration,
        crate::workspace_migration_commands::retry_workspace_migration,
        crate::workspace_migration_commands::get_migration_conflicts,
        crate::workspace_migration_commands::get_journal_statuses,
        crate::workspace_migration_commands::resume_workspace_journal,
        crate::workspace_migration_commands::dismiss_workspace_journal_session,
        crate::workspace_migration_commands::note_migration_reentered,
        crate::workspace_disconnect_commands::disconnect_workspace,
        crate::workspace_disconnect_commands::delete_workspace,
        crate::workspace_disconnect_commands::check_workspace_journal,
        crate::workspace_disconnect_commands::get_workspace_info,
    ]
}
